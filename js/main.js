(function ($) {
  ...
  //hide & show of brand logo and brand image
  $(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
      $('.brand-logo').css('display', 'block');
      $('.text-light').css('display', 'none');
    } else {
      $('.brand-logo').css('display', 'none');
      $('.text-light').css('display', 'block');
    }
  });
  ...
  $('[data-toggle="counter-up"]').each(function(index) {
...
function initMap() {
  ...
  var newDelhi = {lat: 28.6139, lng: 77.2090};
  // The map, centered at New Delhi
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 4, center: newDelhi});
  // The marker, positioned at New Delhi
